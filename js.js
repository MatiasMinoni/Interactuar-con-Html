...
// alert("perdon por matar un gatito")
...
ataque.addEventListener("click", function(){
    ...
    alert("La vida de " + campeones[1].nombre + " es " + ataque);

});


// var contraataque=document.getElementById("parry_ekko");
// contraataque.addEventListener("click", function(){
//     contraataque=(campeones[0].vida - 20);
//     while(campeones[0].vida>0){
//         campeones[0].vida=contraataque;
//         if (contraataque<=0){
//             campeones[0].vida=10;
//             alert("Ganaste");
//         }}});
...
curar.addEventListener("click", function(){
    ...
    while(campeones[0].vida!=100){
        ...
        alert("Pocion: Tu vida es " + campeones[0].vida);
        if (curar>=100){
            campeones[0].vida=90;
...
ataque.addEventListener("click", function(){
    ...
    alert("La vida de " + campeones[0].nombre + " es " + ataque);
